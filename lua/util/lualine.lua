...
M.components = {
  ...
  branch = {
    "branch",
    icon = { I.git.branch, color = { fg = moduleObject.styles.palettes.pink, gui = "bold" } },
    color = { gui = "bold" },
    separator = {
      right = I.navigation.right_half_circle_thick,
    },
  ...
  filename = {
    "filename",
    file_status = false,
    color = { fg = moduleObject.styles.palettes.lavender },
  },
  ...
  treesitter = {
    ...
    color = function()
      ...
      return {
        fg = ts and not vim.tbl_isempty(ts) and moduleObject.styles.palettes.green or moduleObject.styles.palettes.red,
      }
    end,
    cond = M.conditions.hide_in_width,
  },
  ...
  lsp = {
    ...
    color = { fg = moduleObject.styles.palettes.mauve },
    cond = M.conditions.hide_in_width,
  },
  ...
  lsp_progress = {
    ...
    color = { fg = moduleObject.styles.palettes.overlay0 },
    cond = M.conditions.hide_in_width,
  },
  ...
  dap = {
    ...
    icon = I.dap.bug,
    color = { fg = moduleObject.styles.palettes.yellow },
    cond = function()
  ...
  lazy = {
    ...
    color = { fg = moduleObject.styles.palettes.subtext0 },
  ...
  location = {
    ...
    icon = { I.misc.milestone, color = { fg = moduleObject.styles.palettes.pink, gui = "bold" } },
  ...
  scrollbar = {
    ...
    color = { fg = moduleObject.styles.palettes.surface0 },
  },
  ...
  spaces = {
    ...
    cond = M.conditions.hide_in_width,
    color = { fg = moduleObject.styles.palettes.sapphire },
  },
